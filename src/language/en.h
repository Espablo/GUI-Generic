...
#define S_NETWORK_DISCONNECTED                         "No connection to network"
#define S_REGISTRATION_DISABLED                        "Registration disabled!"
#define S_MISSING_CREDENTIALS                          "Unknown AuthKey"
