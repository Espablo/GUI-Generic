...
#define S_NETWORK_DISCONNECTED                         "Keine Verbindung zum Netzwerk"
#define S_REGISTRATION_DISABLED                        "Registrierung deaktiviert!"
#define S_MISSING_CREDENTIALS                          "Unbekannter AuthKey"
