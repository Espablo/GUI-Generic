...
#define S_NETWORK_DISCONNECTED                         "Pas de connexion au réseau"
#define S_REGISTRATION_DISABLED                        "Inscription désactivée!"
#define S_MISSING_CREDENTIALS                          "Clé d’authentification inconnue"
