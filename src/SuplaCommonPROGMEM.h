...
const char RELAY_SWITCH_ON_TIME[] PROGMEM = S_RELAY_SWITCH_ON_TIME;
const char* const TRIGGER_P[] PROGMEM = {REACTION_ON_PRESS, REACTION_ON_RELEASE, REACTION_ON_CHANGE, RELAY_SWITCH_ON_TIME};
