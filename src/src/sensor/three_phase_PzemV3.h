...
class ThreePhasePZEMv3 : public ElectricityMeter {
 public:
  ...
  ThreePhasePZEMv3(int8_t pinRX1, int8_t pinTX1, int8_t pinRX2, int8_t pinTX2, int8_t pinRX3, int8_t pinTX3)
      : pzem{PZEM004Tv30(pinRX1, pinTX1), PZEM004Tv30(pinRX2, pinTX2), PZEM004Tv30(pinRX3, pinTX3)} {
  }
#endif
...
#else
  ThreePhasePZEMv3(HardwareSerial *serial1, HardwareSerial *serial2, HardwareSerial *serial3)
