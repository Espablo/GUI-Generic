...
#define BOARD_SONOFF_MINI      BOARD_SONOFF_BASIC
#define BOARD_MINITIGER_1CH    BOARD_SONOFF_TOUCH
#define BOARD_MINITIGER_2CH    BOARD_SONOFF_TOUCH_2CH
#define BOARD_MINITIGER_3CH    BOARD_SONOFF_TOUCH_3CH
...
const char SONOFF_BASIC[] PROGMEM = "SONOFF BASIC / SONOFF Mini";
